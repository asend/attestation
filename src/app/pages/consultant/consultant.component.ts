...
import { UtilisateurDto, TitreDto, Utilisateur } from 'src/app/services/models';
import { UtilisateurService, TitreService, ProfileService } from 'src/app/services/services';
...
export class ConsultantComponent implements OnInit {
  ...
  users: UtilisateurDto = {prenom: "", nom: "", email: ""};// = new DemandeurDto();
  titres: TitreDto [] = [];
  ...
  constructor(private formBuilder : FormBuilder, private auth: UtilisateurService,
     ...
     private serviceTitre: TitreService, private utilisateurService: UtilisateurService) { }
  ...
  createConsultant(): void {
    this.utilisateurService.registerVisionnaire(this.user).subscribe({
      next: (response: number) => {
        this.router.navigate(['admin/dashbord'])

        console.log('ID retourné par le backend :', response);
        // tu peux rediriger, afficher un message, etc.
      },
